...
at.VCF <- read.vcfR("group_2_accession_1001genomes_snp-short-indel_only_ACGTN_Dp10GQ20Q30_NoIndel_Bialleleic_80PcMissing.vcf.gz")

#vcf <- readVcf("group_2_accession_1001genomes_snp-short-indel_only_ACGTN_Dp10GQ20Q30_NoIndel_Bialleleic_80PcMissing.vcf.gz")
...
plot(density(subset_ITA_td), col = "red", main = "", cex.lab = 1.2, xlim = c(-10.5,-2.5)) 
  title(main = "F", adj = 0, cex.main = 3.5)
...
plot(density(log(ara_data$GER_pi)), col= "green", main="", cex.lab = 1.2, xlim=c(-9, -2.5))
title(main = "F", adj = 0, cex.main = 3.5)
