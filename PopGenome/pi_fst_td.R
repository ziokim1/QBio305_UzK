...
# chromosome 5
At_Chr <- readVCF("group_2_final_accession_1001genomes_snp-short-indel_only_ACGTN_Dp10GQ20Q30_NoIndel_Bialleleic_80PcMissing.vcf.gz", numcols=189, tid="5", frompos = rad4_start, topos = polh_end, include.unknown = TRUE)
...
window_start <- seq(from = rad4_start, to = rad4_end, by = window_jump)
